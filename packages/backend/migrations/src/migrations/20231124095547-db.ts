...
export async function up(db: Kysely<Database>): Promise<void> {
  ...
  await db.schema
    ...
    .addColumn('car_type_id', 'int2', (col) => col.notNull().unsigned())
    .addForeignKeyConstraint('user_id_fk', ['user_id'], 'user', ['id'])
  ...
  await db.schema
    ...
    .addForeignKeyConstraint('driver_id_fk', ['driver_id'], 'user', ['id'])
    .addForeignKeyConstraint('car_id_fk', ['car_id'], 'car', ['id'])
    .execute();
  ...
  await db.schema
    ...
    .addColumn('checkpoint_trip_id', 'int8', (col) => col.notNull().unsigned())
  ...
  await db.schema
    ...
    .addColumn('trip_id', 'int8', (col) => col.notNull().unsigned())
    .addForeignKeyConstraint('sender_id_fk', ['sender_id'], 'user', ['id'])
    .addForeignKeyConstraint('receiver_id_fk', ['receiver_id'], 'user', ['id'])
    .addForeignKeyConstraint('trip_id_fk', ['trip_id'], 'trip', ['id'])
    .execute();
